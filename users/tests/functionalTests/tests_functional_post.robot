...
Teste de Criação de Usuário
    ...
    ${response}    POST On Session    Users    /user/    json=${data}    headers=${headers}
...
Criar Novo Usuário - E-mail Duplicado
    ...
    ${response1}    POST On Session    Users    /user/    json=${data}    headers=${headers}
    ${data}    Create Dictionary    email=test3@example.com    fullName=Jane Doe    CEP=87654321    age=25
    ${response2}    POST On Session    Users    /user/    json=${data}    headers=${headers}
...
Deletar Usuário
    ...
    ${response}    DELETE On Session    Users    /user/    json=${data}    headers=${headers}
